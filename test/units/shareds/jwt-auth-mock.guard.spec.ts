...
import { JwtAuthMockGuard } from 'src/shareds/jwt-auth/presentation/jwt-auth-mock.guard';

describe('JwtAuthMockGuard', () => {
  let guard: JwtAuthMockGuard;
  let reflector: Reflector;

  beforeEach(() => {
    reflector = new Reflector();
    guard = new JwtAuthMockGuard(reflector);
  });
  ...
  describe('canActivate', () => {
    ...
    it('should call super.canActivate when route is not public', () => {
      ...
      const superCanActivate = jest.spyOn(
        Object.getPrototypeOf(JwtAuthMockGuard.prototype),
        'canActivate',
      );
