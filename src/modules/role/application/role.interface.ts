...
export interface RoleInterface extends CRUI<RoleBase, MongooseBase> {
    ...
    deleteById(id: DeleteByIdProps<MongooseBase>): DeleteByIdRes<RoleBase, MongooseBase>;
    delete(props: DeleteProps<RoleBase, MongooseBase>): DeleteRes<RoleBase, MongooseBase>;
}