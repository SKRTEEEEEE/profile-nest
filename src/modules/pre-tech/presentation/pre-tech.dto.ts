...
export class PreTechBaseDto  implements  PreTechBase {
  ...
  @ApiProperty({
        title: "Color",
        description: "Color associated with the technology, in hexadecimal format without hashtag (#).",
        example: "61DAFB",
    })
  @IsString()
  color: string;
...
export class PreTechDto extends PreTechBaseDto implements PreTechBase, MongooseBase{
  @ApiProperty({
    title: "ID",
