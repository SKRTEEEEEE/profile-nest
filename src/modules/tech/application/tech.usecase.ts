...
export class TechUpdateUseCase<TDB> {
    ...
    async updateByForm(props: Partial<TechForm>):  Promise<LengBase&TDB | undefined > {
        return await this.techRepo.updateByForm(props);
    }
    async updateByNameId(nameId: string, updateData: Partial<LengBase>): Promise<LengBase&TDB | undefined |null >{
