...
import { NativeLoggerModule } from './shareds/presentation/native-logger.module';
...
@Module({
  imports: [
    ...
    NativeLoggerModule, // 👈 Global module that exports NativeLoggerService
    PreTechModule,
    TechModule,
    UserModule,
    ProjectModule,
  ...
  controllers: [],
  providers: [
    // NativeLoggerService is now provided by NativeLoggerModule (global)
