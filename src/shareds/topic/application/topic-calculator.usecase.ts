...
import { AllTopicRepoPercentagesRes, AllTopicSizePercentagesRes, TopicCalculatorInterface, TopicGithubDataRes } from "./topic-calculator.interface";
...
export class TopicCalculatorUseCase implements TopicCalculatorInterface {
    ...
    calculateAllTopicSizePercentages(reposDetails: RepoDetailsRes): AllTopicSizePercentagesRes {
    ...
    calculateAllTopicsRepoPercentages(reposDetails: RepoDetailsRes): AllTopicRepoPercentagesRes {
    ...
    calculateTopicGithubData(nameId: string,allTopicsSize: AllTopicSizePercentagesRes, allTopicsRepo: AllTopicRepoPercentagesRes): TopicGithubDataRes {
        ...
        const usogithubString = allTopicsSize.find(lenguaje => {
