...
@Injectable()
export class TechReadOneService<TDB> implements ReadOneRepository<LengBase, TDB>{
    constructor(
...
@Injectable()
export class TechCreateService<TDB> {
    constructor(
...
@Injectable()
export class TechReadService<TDB> {
    constructor(
        private readonly crruudRepository: CRRUUDRepository<LengBase, TDB>
    ) {}
...
@Injectable()
export class TechReadByIdService<TDB> {
    constructor(
        private readonly crruudRepository: CRRUUDRepository<LengBase, TDB>
    ) {}
...
@Injectable()
export class TechUpdateService<TDB> {
    constructor(
        private readonly crruudRepository: CRRUUDRepository<LengBase, TDB>
    ) {}
...
@Injectable()
export class TechUpdateByIdService<TDB> {
    constructor(
        private readonly crruudRepository: CRRUUDRepository<LengBase, TDB>
    ) {}
...
@Injectable()
export class TechDeleteService<TDB> {
    constructor(
        private readonly crruudRepository: CRRUUDRepository<LengBase, TDB>
    ) {}
